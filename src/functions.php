...
if (!function_exists('wp_sir_get_additional_sizes')) :
    ...
    function wp_sir_get_additional_sizes($context = 'read')
    {
        ...
        uksort($sizes, function ($a, $b) {
            return strpos($a, 'woocommerce_') < $b && strpos($a, 'shop_') < $b;
        });
...
if (!function_exists('wp_sir_get_size_dimensions')) :
     ...
     * @return array|null
     */
    function wp_sir_get_size_dimensions($size_name)
    {
        $all_sizes = wp_sir_get_additional_sizes();

        if( isset( $all_sizes[$size_name] ) ){
            return  $all_sizes[$size_name];
        }
